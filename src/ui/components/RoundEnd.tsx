...
export function RoundEnd({
  ...
  return (
    <div className="sheet" role="dialog" aria-modal="true" aria-label="Round result">
...
export function KoiKoiPrompt({
  ...
  return (
    <div className="sheet" role="dialog" aria-modal="true" aria-label="Koi-Koi or stop">
      <div className="sheet__inner sheet__inner--tight">
        <h2>You have {base} points</h2>
        <p className="sheet__explain">
          Stop now and bank them, or call Koi-Koi to keep playing for more — the
          multiplier rises, but your opponent can still take the round.
        </p>
